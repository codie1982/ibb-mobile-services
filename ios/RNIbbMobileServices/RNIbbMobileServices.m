...
@implementation RNIbbMobileServices
{
    bool hasListeners;
}
...
{
    return @[@"RNIbbMobileServices_batteryLevelDidChange", @"RNIbbMobileServices_batteryLevelIsLow", @"RNIbbMobileServices_powerStateDidChange"];
}
...
- (void) batteryLevelDidChange:(NSNotification *)notification {
    ...
    [self sendEventWithName:@"RNIbbMobileServices_batteryLevelDidChange" body:@(batteryLevel)];

    if (batteryLevel <= _lowBatteryThreshold) {
        [self sendEventWithName:@"RNIbbMobileServices_batteryLevelIsLow" body:@(batteryLevel)];
    }
}
...
- (void) powerStateDidChange:(NSNotification *)notification {
    ...
    [self sendEventWithName:@"RNIbbMobileServices_powerStateDidChange" body:self.powerState];
}
...
#else
    __weak RNIbbMobileServices *weakSelf = self;
    dispatch_async(dispatch_get_main_queue(), ^{
        __strong RNIbbMobileServices *strongSelf = weakSelf;
        if (strongSelf) {
